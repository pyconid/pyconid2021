  ...
  data () {
    return {
      contents: [
        ...
        { title: 'Other.', subtitle: 'Sponsoring can show your gratitude for Python community. It is one of CSR activity that supports technology companies and engineers community.' }
      ]
    }
  }
}
